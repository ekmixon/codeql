  ...
  override predicate row(string row) {
    row =
      [
        ...
        "org.springframework.web.util;UriBuilder;true;host;;;Argument[0];ReturnValue;value",
        ...
        "org.springframework.web.util;UriBuilder;true;port;(java.lang.String);;Argument[0];Argument[-1];value",
        "org.springframework.web.util;UriBuilder;true;query;;;Argument[-1];ReturnValue;value",
        "org.springframework.web.util;UriBuilder;true;query;;;Argument[0];Argument[-1];value",
        ...
        "org.springframework.web.util;UriBuilder;true;replaceQuery;;;Argument[0];Argument[-1];value",
        ...
        "org.springframework.web.util;UriBuilder;true;scheme;;;Argument[0];Argument[-1];value",
        "org.springframework.web.util;UriBuilder;true;userInfo;;;Argument[-1];ReturnValue;value",
        "org.springframework.web.util;UriBuilder;true;userInfo;;;Argument[0];Argument[-1];value",
        ...
        "org.springframework.web.util;UriComponentsBuilder;false;fragment;;;Argument[-1];ReturnValue;taint",
